...
public final class EARC0401QBar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      if (_jspx_meth_html_submit_0(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\t\t<!--html:submit styleClass='formcss_rbutton' property='doQry' value='查詢' onclick=\"javascript:return(checkForm(this.form));\"/-->\r\n");
      out.write("\t\t\t");
  ...
  private boolean _jspx_meth_html_submit_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_0.setOnclick("javascript:return(checkForm3(this.form));");
