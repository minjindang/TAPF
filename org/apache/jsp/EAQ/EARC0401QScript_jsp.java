...
public final class EARC0401QScript_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	for (int j = 0; j < txtparam.length; j++)
	{
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function checkForm3(form)\r\n");
      out.write("{\r\n");
      out.write("\tvar alertMessage = \"\";\r\n");
      out.write("\tif (\"\" == form.elements['date(startIssueDate)'].value || \"\" == form.elements['date(endIssueDate)'].value  ) \r\n");
      out.write("    {\r\n");
      out.write("\t\t   alertMessage += \"\\n\";\r\n");
      out.write("           alertMessage += \"【發行日期】不可空白!!\";\r\n");
      out.write("    }\r\n");
      out.write("\t\r\n");
      out.write("\tif(alertMessage!=\"\")\r\n");
      out.write("\t{\r\n");
