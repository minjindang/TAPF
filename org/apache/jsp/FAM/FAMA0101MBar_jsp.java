...
public final class FAMA0101MBar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_html_submit_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_0.setProperty("doDetQry");
    _jspx_th_html_submit_0.setValue("類別明細");
  ...
  private boolean _jspx_meth_html_submit_2(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_2.setProperty("doQry");
    _jspx_th_html_submit_2.setValue("回清單");
  ...
  private boolean _jspx_meth_html_submit_3(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_3.setProperty("doUpd");
    _jspx_th_html_submit_3.setValue("更新");
    _jspx_th_html_submit_3.setOnclick("javascript:return(checkValue(this.form));");
  ...
  private boolean _jspx_meth_html_submit_4(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_4.setProperty("doDel");
    _jspx_th_html_submit_4.setValue("刪除");
  ...
  private boolean _jspx_meth_html_submit_5(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_5.setProperty("goAdd");
