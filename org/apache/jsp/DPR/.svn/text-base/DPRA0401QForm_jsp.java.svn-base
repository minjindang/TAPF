package org.apache.jsp.DPR;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class DPRA0401QForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<input type='hidden' name='title' value='DPRA04'>\r\n");
      ...
      out.write("\t\t\t");
      out.print(gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(gov.dnt.tame.util.ListToolManager.getList("select id, issueSerial from IssueMain  where debtType='D'  and debtCode <>(select id from DebitRef where debitType = 'DA' ) and budgetCode = 3 order by accountYear desc , serialNo desc"),"issueId",10,false));
      out.write("\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      ...
      if (_jspx_meth_html_text_0(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\t\t<a href=\"javascript: myCalendar.setCallBackObj('date(payDate)');myCalendar.show();\"><img src=\"/tapf/assets/images/calendar/dynCalendar.gif\" border=\"0\" align=\"absmiddle\" width=\"16\" height=\"16\" title=\"選擇日期\"/></a>\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t</tr>\r\n");
      out.write("</table>");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_html_text_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_0.setName("DpraReportForm");
    _jspx_th_html_text_0.setProperty("date(payDate)");
