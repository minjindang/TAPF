...
public final class APRA2301QForm_jsp extends org.apache.jasper.runtime.HttpJspBase
...
pageContext.setAttribute("debtNameList",gov.dnt.tame.util.ListToolManager.getList("select id, debtName from IssueMain where debtType='A' and issueKind = '1' order by debt_name , account_year")); 
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item'><font color=\"red\">*</font>銷燬日期</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t");
      out.print(gov.dnt.tame.util.CommonFun.addCalendar("date(killDate)",new Integer(0)));
      out.write("\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item'><font color=\"red\">*</font>銷燬地點</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
  ...
  private boolean _jspx_meth_html_select_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_select_0.setName("Apra2301Form");
    _jspx_th_html_select_0.setProperty("issueId");
    _jspx_th_html_select_0.setOnchange("getDebtName(this.form)");
  ...
  private boolean _jspx_meth_html_hidden_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_0.setName("Apra2301Form");
  ...
  private boolean _jspx_meth_html_text_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_0.setName("Apra2301Form");
    _jspx_th_html_text_0.setProperty("date(killDate)");
  ...
  private boolean _jspx_meth_html_text_1(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_1.setName("Apra2301Form");
    _jspx_th_html_text_1.setProperty("killPlace");
