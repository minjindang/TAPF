...
public final class GAMA0105AForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_html_hidden_9(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_9.setProperty("myIssDet.deleteRemark");
    _jspx_th_html_hidden_9.setValue("N");
  ...
  private boolean _jspx_meth_html_hidden_10(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_10.setProperty("bigDecimal(myIssDet.realAmount)");
    _jspx_th_html_hidden_10.setValue("0");
