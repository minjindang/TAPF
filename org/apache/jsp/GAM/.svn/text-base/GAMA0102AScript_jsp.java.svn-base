...
public final class GAMA0102AScript_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("{\r\n");
      out.write("\tform.action = \"GAMA0107\";\r\n");
      out.write("\tform.submit();\r\n");
      out.write("}\r\n");
      out.write("function changeAmount(form)\r\n");
      out.write("{\r\n");
      out.write("\tform.action = \"GAMA0102ACOUNT\";\r\n");
      out.write("\tform.submit();\r\n");
      out.write("}\r\n");
      ...
      out.write("\t{\r\n");
      out.write("\t\tform.action = \"GAMA0133\";\r\n");
      out.write("\t\tform.submit();\r\n");
      out.write("\t}\t\r\n");
      out.write("}\r\n");
      ...
      out.write("\tvar compare = Number(replaceAll(form.elements['bigDecimal(compareAmount)'].value,\",\",\"\")) / Number(replaceAll(form.elements['bigDecimal(issueAmountDet)'].value,\",\",\"\"))\r\n");
      out.write("\tif(planAmount < compare)\r\n");
      out.write("\t{\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t if(\"\" == form.bankId.value && form.bankId.value < 0 )\r\n");
      out.write("    {\r\n");
      ...
      out.write("        result = false;\r\n");
      out.write("    }\r\n");
      out.write("    if(\"\" == form.elements['bigDecimal(originInterestAmount)'].value && form.elements['bigDecimal(originInterestAmount)'].value < 0 )\r\n");
      out.write("    {\r\n");
      out.write("    \talert(\"【利息】不可空白!\");\r\n");
      out.write("    \tresult = false;\r\n");
      out.write("    }\r\n");
      out.write("    if(\"\" == form.elements['bigDecimal(totalAmount)'].value && form.elements['bigDecimal(totalAmount)'].value < 0)\r\n");
      out.write("    {\r\n");
