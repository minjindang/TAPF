...
public final class GAMA0903MLBar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_html_submit_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_0.setValue("新增計息期別");
  ...
  private boolean _jspx_meth_html_submit_1(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_1.setProperty("doComitRate");
    _jspx_th_html_submit_1.setValue("確認計息期別");
    _jspx_th_html_submit_1.setOnclick("javascript:return(checkRate(this.form));");
