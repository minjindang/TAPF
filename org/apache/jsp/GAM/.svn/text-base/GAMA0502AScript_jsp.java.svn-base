...
public final class GAMA0502AScript_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t//document.getElementById(\"oldKeepAmount\").innerHTML = addMoneyMask(keepAmount);\r\n");
      out.write("}\r\n");
      out.write("function getOldKeepAmount(form)\r\n");
      out.write("{\r\n");
      out.write("\tvar keepAmount = parseFloat(replaceAll(form.elements['bigDecimal(keepAmount)'].value,\",\",\"\"));\r\n");
      out.write("\tdocument.getElementById(\"oldKeepAmount\").innerHTML = addMoneyMask(keepAmount);\r\n");
      out.write("\tform.elements['bigDecimal(oldKeepAmount)'].value = addMoneyMask(keepAmount);\r\n");
      out.write("}\r\n");
      ...
      out.write("\tvar plusdebtAmount = parseFloat(replaceAll(form.elements['bigDecimal(plusdebtAmount)'].value,\",\",\"\"));\r\n");
      ...
      out.write("\t}\r\n");
      out.write("}\r\n");
      out.write("function change(form)\r\n");
      out.write("{\r\n");
      out.write("\tvar mainAccountYear = \"");
      out.print(request.getAttribute("mainAccountYear"));
      out.write("\";\r\n");
      out.write("\tif(form.dataType.value!=\"\" && form.banish.value !=\"\")\r\n");
      out.write("\t\tdoAction(\"GAMA0502A\");\r\n");
      out.write("}\r\n");
