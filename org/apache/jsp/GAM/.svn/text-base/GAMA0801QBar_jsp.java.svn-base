...
public final class GAMA0801QBar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<!--  html:submit styleClass='formcss_rbutton' property='doQry' value='查詢' onclick=\"return checkForm(this.form);\"/-->\r\n");
      out.write("\t\t\t<!--  html:reset  styleClass='formcss_rbutton' property='reset' value='清除'/-->\r\n");
      out.write("\t\t\t");
