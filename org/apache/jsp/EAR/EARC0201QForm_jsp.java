...
public final class EARC0201QForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<select name=\"issueId\" onblur=\"if('A'=='");
      ...
      _jspx_th_c_if_1.setTest("${debtTypeCode eq 'A'}");
      ...
      if (_jspx_eval_c_if_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          _jspx_th_c_forEach_1.setItems("${AccountQueryForm.debtList}");
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item'>會計科目</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
  ...
  private boolean _jspx_meth_c_out_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_out_0.setValue("${AccountQueryForm.issueYear}");
  ...
  private boolean _jspx_meth_c_out_1(PageContext _jspx_page_context)
    ...
    _jspx_th_c_out_1.setValue("${SYSID}");
  ...
  private boolean _jspx_meth_c_out_2(PageContext _jspx_page_context)
    ...
    _jspx_th_c_out_2.setValue("${debtTypeCode}");
  ...
  private boolean _jspx_meth_c_out_3(PageContext _jspx_page_context)
    ...
    _jspx_th_c_out_3.setValue("${SYSID}");
  ...
  private boolean _jspx_meth_c_forEach_0(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_0.setItems("${AccountQueryForm.issueList}");
  ...
  private boolean _jspx_meth_c_out_4(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_out_4.setValue("${issue.id}");
  ...
  private boolean _jspx_meth_c_if_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_if_0.setTest("${issue.id eq AccountQueryForm.issueId}");
  ...
  private boolean _jspx_meth_c_out_5(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_out_5.setValue("${issue.debtName}");
  ...
  private boolean _jspx_meth_c_out_6(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_out_6.setValue("${debt.id}");
  ...
  private boolean _jspx_meth_c_if_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_if_2.setTest("${debt.id eq AccountQueryForm.debtId}");
  ...
  private boolean _jspx_meth_c_out_7(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_out_7.setValue("${issue.debtName}");
  ...
  private boolean _jspx_meth_html_select_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_select_0.setProperty("accountId");
  ...
  private boolean _jspx_meth_html_optionsCollection_0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_select_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_optionsCollection_0.setProperty("accountList");
    _jspx_th_html_optionsCollection_0.setLabel("accountName");
  ...
  private boolean _jspx_meth_c_if_3(PageContext _jspx_page_context)
    ...
    _jspx_th_c_if_3.setTest("${debtTypeCode eq 'A'}");
    int _jspx_eval_c_if_3 = _jspx_th_c_if_3.doStartTag();
    if (_jspx_eval_c_if_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t<tr>\r\n");
        out.write("\t\t\t<td class='table_item'>傳票種類</td>\r\n");
        out.write("\t\t\t<td class='table_td'>\r\n");
        out.write("\t\t\t\t");
        if (_jspx_meth_html_select_1(_jspx_th_c_if_3, _jspx_page_context))
          return true;
        out.write("\r\n");
        out.write("\t\t\t</td>\r\n");
        out.write("\t\t</tr>\r\n");
  ...
  private boolean _jspx_meth_html_select_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_if_3, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  html:select
    ...
    _jspx_th_html_select_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_if_3);
    ...
    if (_jspx_eval_html_select_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\t\t\t\t\t<option value=\"0\">登錄</option>\r\n");
        out.write("\t\t\t\t\t<option value=\"1\">債票</option>\r\n");
        out.write("\t\t\t\t");
