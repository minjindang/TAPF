...
public final class GARA3401QScript_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tobj.amountUnitLabel.value = obj.amountUnit_options.options[obj.amountUnit_options.selectedIndex].text;\r\n");
      out.write("\telse\r\n");
      out.write("\t\tobj.amountUnitLabel.value = \"\";\r\n");
      out.write("}\r\n");
      out.write("function checkValue(form)\r\n");
      out.write("{\r\n");
      out.write("\tvar cols = new Array(\"accountSyear\" , \"accountEyear\" , \"amountUnit\");\r\n");
      out.write("\tvar colNames = new Array(\"【發行年度(起)】\",\"【發行年度(訖)】\", \"【金額單位】\");\r\n");
