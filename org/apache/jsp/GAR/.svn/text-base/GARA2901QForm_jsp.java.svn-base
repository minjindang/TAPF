...
public final class GARA2901QForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<!--\tGARA2901QForm.jsp\r\n");
      out.write("程式目的：GARA2901\r\n");
      out.write("程式代號：GARA2901\r\n");
      ...
      _jspx_th_logic_notEmpty_0.setName("Gara2901Form");
      _jspx_th_logic_notEmpty_0.setProperty("amountUnit");
      ...
      if (_jspx_eval_logic_notEmpty_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          _jspx_th_bean_define_0.setId("amountUnit");
          _jspx_th_bean_define_0.setName("Gara2901Form");
          _jspx_th_bean_define_0.setProperty("amountUnit");
          ...
          java.lang.String amountUnit = null;
          amountUnit = (java.lang.String) _jspx_page_context.findAttribute("amountUnit");
          out.write("\r\n");
          out.write("\t\t\t\t");
          out.print(gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(tw.gov.nta.system.common.CodeDetManage.getCodeDet("BU"),"amountUnit",amountUnit,"amountUnit","getSelectValue(this.form)"));
          out.write("\r\n");
          out.write("\t\t\t");
      ...
      _jspx_th_logic_empty_0.setName("Gara2901Form");
      _jspx_th_logic_empty_0.setProperty("amountUnit");
...
pageContext.setAttribute("collectionCodeDet",tw.gov.nta.system.common.CodeDetManage.getCodeDet("BU")); 
          out.write("\r\n");
          out.write("\t\t\t\t");
          if (_jspx_meth_html_select_0(_jspx_th_logic_empty_0, _jspx_page_context))
            return;
          out.write("\r\n");
          out.write("\t\t\t");
  ...
  private boolean _jspx_meth_html_text_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_0.setName("Gara2901Form");
    _jspx_th_html_text_0.setProperty("accountSyear");
  ...
  private boolean _jspx_meth_html_text_1(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_1.setName("Gara2901Form");
    _jspx_th_html_text_1.setProperty("accountEyear");
  ...
  private boolean _jspx_meth_html_select_0(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_empty_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  html:select
    ...
    _jspx_th_html_select_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_logic_empty_0);
    _jspx_th_html_select_0.setName("Gara2901Form");
  ...
  private boolean _jspx_meth_html_hidden_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_0.setName("Gara2901Form");
