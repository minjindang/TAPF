...
public final class GARA1201QForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<!--\tGARA1201QForm.jsp\r\n");
      out.write("程式目的：GARA1201\r\n");
      out.write("程式代號：GARA1201\r\n");
      ...
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item' width='30%'><font color=\"red\">*</font>發行年度</td>\r\n");
...
pageContext.setAttribute("collectionCodeDet",tw.gov.nta.system.common.CodeDetManage.getCodeDet("BU")); 
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item'>製表日期</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t");
      out.print(gov.dnt.tame.util.CommonFun.addCalendar("date(createDate)", new Integer(0)));
      out.write("\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
...
request.setAttribute("memo",((GaraNote)new GaraNoteManager().getGaraNote((String)request.getAttribute("PATH"))).getMemo()); 
      ...
      out.write("'/>\r\n");
      out.write("\t\t\t<textarea name=\"memo\" rows=\"10\" cols=\"100\" >");
  ...
  private boolean _jspx_meth_html_text_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_0.setName("Gara1201Form");
    _jspx_th_html_text_0.setProperty("issueYear");
  ...
  private boolean _jspx_meth_html_select_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_select_0.setName("Gara1201Form");
  ...
  private boolean _jspx_meth_html_text_1(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_1.setName("Gara1201Form");
    _jspx_th_html_text_1.setProperty("date(createDate)");
