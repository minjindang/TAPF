...
public final class CIRA0601QForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<!--\tCIRA0601QForm.jsp\r\n");
      out.write("程式目的：CIRA0601\r\n");
      out.write("程式代號：CIRA0601\r\n");
      ...
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item'><font color=\"red\">*</font>償還狀態</td>\r\n");
...
pageContext.setAttribute("statusList",tw.gov.nta.system.common.CodeDetManage.getCodeDet("RS")); 
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item'>年度起迄</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item'>借款日期起迄</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("~\r\n");
      out.write("\t\t\t");
      out.print(gov.dnt.tame.util.CommonFun.addCalendar("date(startDate)",new Integer(0)));
      out.write("\r\n");
      out.write("\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t");
      out.print(gov.dnt.tame.util.CommonFun.addCalendar("date(endDate)",new Integer(1)));
      out.write("\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item'>銀行別</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
pageContext.setAttribute("bankCodeList",tw.gov.nta.system.common.BankCodeManage.getBankInfo()); 
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item'><font color=\"red\">*</font>利率基準日</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t");
      out.print(gov.dnt.tame.util.CommonFun.addCalendar("date(baseDate)",new Integer(2)));
      out.write("\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item'><font color=\"red\">*</font>金額單位</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
pageContext.setAttribute("collectionCodeDet",tw.gov.nta.system.common.CodeDetManage.getCodeDet("BU")); 
      out.write("\r\n");
      out.write("\t\t\t");
      if (_jspx_meth_html_select_4(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("\t\t\t");
  ...
  private boolean _jspx_meth_html_select_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_select_0.setName("Cira0601Form");
    _jspx_th_html_select_0.setProperty("status");
  ...
  private boolean _jspx_meth_html_options_0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_select_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_options_0.setCollection("statusList");
  ...
  private boolean _jspx_meth_html_text_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_0.setName("Cira0601Form");
  ...
  private boolean _jspx_meth_html_text_1(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_1.setName("Cira0601Form");
  ...
  private boolean _jspx_meth_html_text_2(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_2.setName("Cira0601Form");
    _jspx_th_html_text_2.setProperty("date(startDate)");
  ...
  private boolean _jspx_meth_html_text_3(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_3.setName("Cira0601Form");
    _jspx_th_html_text_3.setProperty("date(endDate)");
  ...
  private boolean _jspx_meth_html_select_1(PageContext _jspx_page_context)
    ...
    _jspx_th_html_select_1.setName("Cira0601Form");
    _jspx_th_html_select_1.setProperty("budgetCode");
    _jspx_th_html_select_1.setOnchange("changeValue(this.form)");
  ...
  private boolean _jspx_meth_html_optionsCollection_0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_select_1, PageContext _jspx_page_context)
    ...
    _jspx_th_html_optionsCollection_0.setName("Cira0601Form");
  ...
  private boolean _jspx_meth_html_hidden_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_0.setName("Cira0601Form");
    _jspx_th_html_hidden_0.setProperty("budgetLabel");
  ...
  private boolean _jspx_meth_html_select_2(PageContext _jspx_page_context)
    ...
    _jspx_th_html_select_2.setName("Cira0601Form");
    _jspx_th_html_select_2.setProperty("debtCode");
    _jspx_th_html_select_2.setOnchange("getLabel(this.form)");
    ...
    if (_jspx_eval_html_select_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("\r\n");
        out.write("\t\t\t\t\t");
        if (_jspx_meth_logic_notEmpty_0(_jspx_th_html_select_2, _jspx_page_context))
          return true;
        out.write("\r\n");
        out.write("\t\t\t");
  ...
  private boolean _jspx_meth_logic_notEmpty_0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_select_2, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  logic:notEmpty
    ...
    _jspx_th_logic_notEmpty_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_html_select_2);
    _jspx_th_logic_notEmpty_0.setName("Cira0601Form");
    _jspx_th_logic_notEmpty_0.setProperty("debtCodeList");
  ...
  private boolean _jspx_meth_html_optionsCollection_1(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_notEmpty_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_optionsCollection_1.setName("Cira0601Form");
  ...
  private boolean _jspx_meth_html_hidden_1(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_1.setName("Cira0601Form");
    _jspx_th_html_hidden_1.setProperty("debtLabel");
  ...
  private boolean _jspx_meth_html_text_4(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_4.setName("Cira0601Form");
    _jspx_th_html_text_4.setProperty("startSerial");
    _jspx_th_html_text_4.setSize("10");
    _jspx_th_html_text_4.setMaxlength("5");
  ...
  private boolean _jspx_meth_html_text_5(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_5.setName("Cira0601Form");
    _jspx_th_html_text_5.setProperty("endSerial");
    _jspx_th_html_text_5.setSize("10");
    _jspx_th_html_text_5.setMaxlength("5");
  ...
  private boolean _jspx_meth_html_select_3(PageContext _jspx_page_context)
    ...
    _jspx_th_html_select_3.setName("Cira0601Form");
    _jspx_th_html_select_3.setProperty("bankCode");
  ...
  private boolean _jspx_meth_html_options_1(javax.servlet.jsp.tagext.JspTag _jspx_th_html_select_3, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  html:options
    org.apache.struts.taglib.html.OptionsTag _jspx_th_html_options_1 = (org.apache.struts.taglib.html.OptionsTag) _jspx_tagPool_html_options_property_labelProperty_labelName_collection_nobody.get(org.apache.struts.taglib.html.OptionsTag.class);
    ...
    _jspx_th_html_options_1.setCollection("bankCodeList");
    _jspx_th_html_options_1.setLabelName("valuess");
    ...
    if (_jspx_th_html_options_1.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
      return true;
    _jspx_tagPool_html_options_property_labelProperty_labelName_collection_nobody.reuse(_jspx_th_html_options_1);
    return false;
  }
  ...
  private boolean _jspx_meth_html_text_6(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_6.setName("Cira0601Form");
    _jspx_th_html_text_6.setProperty("date(baseDate)");
  ...
  private boolean _jspx_meth_html_select_4(PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  html:select
    org.apache.struts.taglib.html.SelectTag _jspx_th_html_select_4 = (org.apache.struts.taglib.html.SelectTag) _jspx_tagPool_html_select_property_onchange_name.get(org.apache.struts.taglib.html.SelectTag.class);
    _jspx_th_html_select_4.setPageContext(_jspx_page_context);
    _jspx_th_html_select_4.setParent(null);
    _jspx_th_html_select_4.setName("Cira0601Form");
    _jspx_th_html_select_4.setProperty("baseUnit");
    _jspx_th_html_select_4.setOnchange("getSelectValue(this.form)");
    ...
    if (_jspx_eval_html_select_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\r\n");
        out.write("\t\t\t\t");
        if (_jspx_meth_html_option_4(_jspx_th_html_select_4, _jspx_page_context))
          return true;
        out.write("\r\n");
        out.write("\t\t\t\t");
    ...
    if (_jspx_th_html_select_4.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
      return true;
    _jspx_tagPool_html_select_property_onchange_name.reuse(_jspx_th_html_select_4);
    return false;
  }

  private boolean _jspx_meth_html_option_4(javax.servlet.jsp.tagext.JspTag _jspx_th_html_select_4, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  html:option
    ...
    _jspx_th_html_option_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_html_select_4);
  ...
  private boolean _jspx_meth_html_options_2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_select_4, PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  html:options
    org.apache.struts.taglib.html.OptionsTag _jspx_th_html_options_2 = (org.apache.struts.taglib.html.OptionsTag) _jspx_tagPool_html_options_property_labelProperty_labelName_collection_nobody.get(org.apache.struts.taglib.html.OptionsTag.class);
    ...
    _jspx_th_html_options_2.setCollection("collectionCodeDet");
    _jspx_th_html_options_2.setLabelName("valuess");
    _jspx_th_html_options_2.setLabelProperty("label");
    _jspx_th_html_options_2.setProperty("valuess");
    ...
    if (_jspx_th_html_options_2.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
      return true;
    _jspx_tagPool_html_options_property_labelProperty_labelName_collection_nobody.reuse(_jspx_th_html_options_2);
    return false;
  }
  ...
  private boolean _jspx_meth_html_hidden_2(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_2.setName("Cira0601Form");
    _jspx_th_html_hidden_2.setProperty("baseUnitValue");
