...
public final class DIMA0202MForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<!-- DIMA0102MForm.jsp\r\n");
      out.write("程式目的：DIMA02\r\n");
      out.write("程式代號：DIMA02\r\n");
      ...
      _jspx_th_bean_define_1.setName("Dima0202Form");
      ...
      out.write("\r\n");
      out.write("\t\t\t");
      out.print( gov.dnt.tame.util.DateUtil.date2ROCStr(issueDate)+"~"+ gov.dnt.tame.util.DateUtil.date2ROCStr(dueDate));
      out.write("\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item'><font color=\"red\">*</font>銀行編號</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      //  bean:define
      ...
      _jspx_th_bean_define_2.setId("bank");
      _jspx_th_bean_define_2.setName("Dima0202Form");
      _jspx_th_bean_define_2.setProperty("bank");
      _jspx_th_bean_define_2.setType("tw.gov.nta.sql.debt.BankRef");
      ...
      _jspx_th_bean_define_3.setId("accountYear");
      _jspx_th_bean_define_3.setName("Dima0202Form");
      _jspx_th_bean_define_3.setProperty("accountYear");
      ...
      java.lang.String accountYear = null;
      accountYear = (java.lang.String) _jspx_page_context.findAttribute("accountYear");
      out.write("\r\n");
      out.write("\t\t\t");
// gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(tw.gov.nta.debt.common.ContractBankManager.getBankByAccountYear(accountYear),"bankCode",bank.getBankCode(),"","getBankRefId(this.form.bankCode.value)",10,true)
      out.write("\r\n");
      out.write("\t\t\t");
      out.print( gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(tw.gov.nta.system.common.BankCodeManage.getBankCodeDIM(),"bankCode",bank.getBankCode(),"","getBankRefId(this.form.bankCode.value)",10,true));
      out.write("\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item'> 得標金額</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item'>利息</td>\r\n");
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item'>本息合計</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item'>另行訂定合約</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      //  logic:notEmpty
      ...
      _jspx_th_logic_notEmpty_0.setName("Dima0202Form");
      ...
      if (_jspx_eval_logic_notEmpty_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          _jspx_th_bean_define_4.setId("budgetYear");
          _jspx_th_bean_define_4.setName("Dima0202Form");
          _jspx_th_bean_define_4.setProperty("budgetYear");
          ...
          java.lang.String budgetYear = null;
          budgetYear = (java.lang.String) _jspx_page_context.findAttribute("budgetYear");
          out.write("\r\n");
          out.write("\t\t\t\t<input type=\"checkbox\" name=\"budgetYear\" ");
          out.print("Y".equals(budgetYear.trim())?"checked":"");
          out.write(">\r\n");
          out.write("\t\t\t");
  ...
  private boolean _jspx_meth_html_hidden_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_0.setName("Dima0202Form");
  ...
  private boolean _jspx_meth_html_hidden_1(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_1.setName("Dima0202Form");
    _jspx_th_html_hidden_1.setProperty("bankId");
  ...
  private boolean _jspx_meth_html_hidden_2(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_2.setName("Dima0202Form");
    _jspx_th_html_hidden_2.setProperty("kindId");
  ...
  private boolean _jspx_meth_html_hidden_3(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_3.setName("Dima0202Form");
  ...
  private boolean _jspx_meth_html_hidden_4(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_4.setName("Dima0202Form");
  ...
  private boolean _jspx_meth_html_hidden_5(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_5.setName("Dima0202Form");
    _jspx_th_html_hidden_5.setProperty("qryAccountYear");
  ...
  private boolean _jspx_meth_html_hidden_6(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_6.setName("Dima0202Form");
    _jspx_th_html_hidden_6.setProperty("qrySerialNo");
  ...
  private boolean _jspx_meth_html_hidden_7(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_7.setName("Dima0202Form");
    _jspx_th_html_hidden_7.setProperty("qryId");
  ...
  private boolean _jspx_meth_html_hidden_8(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_8.setName("Dima0202Form");
    _jspx_th_html_hidden_8.setProperty("accrue");
  ...
  private boolean _jspx_meth_html_hidden_9(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_9.setName("Dima0202Form");
    _jspx_th_html_hidden_9.setProperty("days");
  ...
  private boolean _jspx_meth_bean_write_0(PageContext _jspx_page_context)
    ...
    _jspx_th_bean_write_0.setName("Dima0202Form");
  ...
  private boolean _jspx_meth_html_text_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_0.setName("Dima0202Form");
    _jspx_th_html_text_0.setProperty("bigDecimal(compareAmount)");
  ...
  private boolean _jspx_meth_html_text_1(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_1.setName("Dima0202Form");
    _jspx_th_html_text_1.setProperty("bigDecimal(compareRate)");
    _jspx_th_html_text_1.setSize("20");
    _jspx_th_html_text_1.setMaxlength("20");
    _jspx_th_html_text_1.setOnblur("getAmount()");
  ...
  private boolean _jspx_meth_html_text_2(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_2.setName("Dima0202Form");
    _jspx_th_html_text_2.setProperty("bigDecimal(issueAmount)");
    _jspx_th_html_text_2.setSize("20");
    _jspx_th_html_text_2.setMaxlength("20");
    _jspx_th_html_text_2.setOnblur("getAmount()");
  ...
  private boolean _jspx_meth_html_text_3(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_3.setName("Dima0202Form");
    _jspx_th_html_text_3.setProperty("bigDecimal(originInterestAmount)");
    _jspx_th_html_text_3.setSize("20");
    _jspx_th_html_text_3.setMaxlength("20");
    _jspx_th_html_text_3.setOnblur("getTotalAmount()");
  ...
  private boolean _jspx_meth_html_text_4(PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  html:text
    org.apache.struts.taglib.html.TextTag _jspx_th_html_text_4 = (org.apache.struts.taglib.html.TextTag) _jspx_tagPool_html_text_size_readonly_property_name_maxlength_nobody.get(org.apache.struts.taglib.html.TextTag.class);
    _jspx_th_html_text_4.setPageContext(_jspx_page_context);
    _jspx_th_html_text_4.setParent(null);
    _jspx_th_html_text_4.setName("Dima0202Form");
    _jspx_th_html_text_4.setProperty("bigDecimal(allAmount)");
    ...
    if (_jspx_th_html_text_4.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
      return true;
    _jspx_tagPool_html_text_size_readonly_property_name_maxlength_nobody.reuse(_jspx_th_html_text_4);
    return false;
  }
  ...
  private boolean _jspx_meth_logic_empty_0(PageContext _jspx_page_context)
    ...
    _jspx_th_logic_empty_0.setName("Dima0202Form");
    _jspx_th_logic_empty_0.setProperty("budgetYear");
  ...
  private boolean _jspx_meth_html_text_5(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_5.setName("Dima0202Form");
    _jspx_th_html_text_5.setProperty("remark");
