...
public final class DIMA0201ABar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_html_submit_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_0.setProperty("doAdd");
    _jspx_th_html_submit_0.setValue("新增");
  ...
  private boolean _jspx_meth_html_submit_1(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_1.setProperty("doClear");
    _jspx_th_html_submit_1.setValue("清畫面");
    _jspx_th_html_submit_1.setOnclick("javascript:return(clearValue(this.form));");
