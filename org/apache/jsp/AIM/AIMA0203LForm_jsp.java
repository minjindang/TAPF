...
public final class AIMA0203LForm_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      if (_jspx_eval_display_table_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_display_column_0.setTitle("面額");
          ...
          if (_jspx_eval_display_column_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jspx_th_bean_define_1.setId("issueTicketId");
              ...
              java.lang.Integer issueTicketId = null;
              issueTicketId = (java.lang.Integer) _jspx_page_context.findAttribute("issueTicketId");
              out.write("\r\n");
              out.write("\t\t\t\t");
          ...
          _jspx_th_display_column_2.setTitle("發行額");
          ...
          if (_jspx_eval_display_column_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jspx_th_bean_define_2.setId("ticketCount");
              _jspx_th_bean_define_2.setName("row");
              _jspx_th_bean_define_2.setProperty("ticketCount");
              _jspx_th_bean_define_2.setType("java.lang.Long");
              ...
              _jspx_th_bean_define_3.setId("ticketAmount");
              _jspx_th_bean_define_3.setName("row");
              _jspx_th_bean_define_3.setProperty("ticketAmount");
              ...
              out.print( new java.text.DecimalFormat("#,###").format(ticketAmount.multiply(new java.math.BigDecimal(ticketCount.toString()))));
              out.write("\r\n");
              out.write("\t\t\t\t\t元</p>\r\n");
              out.write("\t\t\t\t");
  ...
  private boolean _jspx_meth_bean_write_3(javax.servlet.jsp.tagext.JspTag _jspx_th_display_column_0, PageContext _jspx_page_context)
    ...
    _jspx_th_bean_write_3.setProperty("ticketAmount");
  ...
  private boolean _jspx_meth_display_column_1(javax.servlet.jsp.tagext.JspTag _jspx_th_display_table_0, PageContext _jspx_page_context)
    ...
    _jspx_th_display_column_1.setTitle("張數");
    ...
    if (_jspx_eval_display_column_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t<p align=\"right\">");
        if (_jspx_meth_bean_write_4(_jspx_th_display_column_1, _jspx_page_context))
          return true;
        out.write("</p>\r\n");
        out.write("\t\t\t\t");
  ...
  private boolean _jspx_meth_bean_write_4(javax.servlet.jsp.tagext.JspTag _jspx_th_display_column_1, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  bean:write
    ...
    _jspx_th_bean_write_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_display_column_1);
    _jspx_th_bean_write_4.setName("row");
    _jspx_th_bean_write_4.setProperty("ticketCount");
