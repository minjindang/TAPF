...
public final class AIMA0202LForm_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      if (_jspx_eval_display_table_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_display_column_0.setTitle("預算別");
          ...
          if (_jspx_eval_display_column_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jspx_th_bean_define_0.setId("debtId");
              ...
              _jspx_th_bean_define_1.setName("Aima0202MForm");
              _jspx_th_bean_define_1.setProperty("issueMainId");
          ...
          _jspx_th_display_column_1.setTitle("債務別");
          ...
          _jspx_th_display_column_3.setTitle("實收額");
          ...
          if (_jspx_eval_display_column_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              out.write("\r\n");
              out.write("\t\t\t\t\t<p align=\"right\">");
              if (_jspx_meth_bean_write_4(_jspx_th_display_column_3, _jspx_page_context))
                return;
              out.write("元</p>\r\n");
              out.write("\t\t\t\t\t");
              //  bean:define
              ...
              _jspx_th_bean_define_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_display_column_3);
              _jspx_th_bean_define_3.setId("realAmount");
              _jspx_th_bean_define_3.setName("row");
              _jspx_th_bean_define_3.setProperty("realAmount");
  ...
  private boolean _jspx_meth_bean_write_1(PageContext _jspx_page_context)
    ...
    _jspx_th_bean_write_1.setProperty("issueAmount");
  ...
  private boolean _jspx_meth_bean_write_2(PageContext _jspx_page_context)
    ...
    _jspx_th_bean_write_2.setProperty("repayInterestAmount");
  ...
  private boolean _jspx_meth_bean_write_3(javax.servlet.jsp.tagext.JspTag _jspx_th_display_column_2, PageContext _jspx_page_context)
    ...
    _jspx_th_bean_write_3.setProperty("issueAmount");
  ...
  private boolean _jspx_meth_bean_write_4(javax.servlet.jsp.tagext.JspTag _jspx_th_display_column_3, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  bean:write
    ...
    _jspx_th_bean_write_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_display_column_3);
    _jspx_th_bean_write_4.setName("row");
    _jspx_th_bean_write_4.setProperty("realAmount");
