...
public final class AIMA0103AForm_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      if (_jspx_eval_logic_empty_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("\t\t\t\t\t");
          out.print(gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(tw.gov.nta.system.common.CodeDetManage.getCodeDet("MY"),"ticketAmount","","","countTotalAmount(this.form);",10,true));
          out.write("元\r\n");
          out.write("\t\t\t\t");
      ...
      if (_jspx_eval_logic_notEmpty_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\r\n");
          out.write("\t\t\t\t\t");
          out.print(gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(tw.gov.nta.system.common.CodeDetManage.getCodeDet("MY"),"ticketAmount",ticketAmount,"","countTotalAmount(this.form);",10,true));
          out.write("元\r\n");
          out.write("\t\t\t\t");
