...
public final class IssueSerialE_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
				...
				for(int j=0;j<object.length;j++)
				{
					if( object[j]!=null )
					{
						...
						if( "serialno".equals( textName ) )
						{
							...
							//out.print("\t\t parent.document.getElementById(\"issueSerialid\").innerHTML = '"+accountYear+"-"+serialNo+"';  \r\n");
							out.print("\t\tparent.MainForm.debtName.value = '"+accountYear+"-"+serialNo+"概括承接債務'; \r\n");
							out.print("\t\tparent.MainForm.serialNo.value = '"+serialNo+"'; \r\n");
							out.print("\t\tparent.MainForm.issueSerial.value = '"+accountYear+"-"+serialNo+"'; \r\n");
						}
					}
				}
			}
	...
	else
	{
		...
		out.print("\t\tparent.MainForm.debtName.value = '"+accountYear+"-01概括承接債務'; \r\n");
