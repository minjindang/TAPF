...
public final class HAMB0601MScript_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tif( form.SUP_YEAR.value == \"\")\r\n");
      out.write("\t{\r\n");
      out.write("\t\tisValid = false;\r\n");
      out.write("\t\tsError += \"\\n\";\r\n");
      out.write("        sError += \"【記帳年度】不可空白!!\";\r\n");
      out.write("        form.SUP_YEAR.focus();\r\n");
      out.write("        alert(sError);\r\n");
      out.write("\t\treturn isValid;\r\n");
      out.write("\r\n");
      out.write("\t}\r\n");
      out.write("\tif( form.SUP_MONTH.value == \"\")\r\n");
      out.write("\t{\r\n");
      out.write("\t\tisValid = false;\r\n");
      out.write("\t\tsError += \"\\n\";\r\n");
      out.write("        sError += \"【撥款月份】不可空白!!\";\r\n");
      out.write("        form.SUP_MONTH.focus();\r\n");
      out.write("        alert(sError);\r\n");
      out.write("\t\treturn isValid;\r\n");
      out.write("\t}\r\n");
      out.write("\tif( form.SUP_DATE.value == \"\")\r\n");
      out.write("\t{\r\n");
      out.write("\t\tisValid = false;\r\n");
      out.write("\t\tsError += \"\\n\";\r\n");
      out.write("        sError += \"【匯款日期】不可空白!!\";\r\n");
      out.write("        form.SUP_DATE.focus();\r\n");
      out.write("        alert(sError);\r\n");
      out.write("\t\treturn isValid;\r\n");
      out.write("\t}\r\n");
      out.write("\tif( form.supCount.value == \"\")\r\n");
      out.write("\t{\r\n");
      out.write("\t\tisValid = false;\r\n");
      out.write("\t\tsError += \"\\n\";\r\n");
      out.write("        sError += \"【撥款次數】不可空白!!\";\r\n");
      out.write("        form.supCount.focus();\r\n");
      out.write("        alert(sError);\r\n");
      out.write("\t\treturn isValid;\r\n");
      out.write("\t}\r\n");
      out.write("\tif (!(CheckValidDate(form.SUP_DATE.value)))\r\n");
      out.write("    {\r\n");
      out.write("    \tisValid = false;\r\n");
      out.write("    \tform.SUP_DATE.select();\r\n");
      out.write("\t\treturn isValid;\r\n");
      out.write("    }\r\n");
      out.write("\treturn isValid;\t\r\n");
      out.write("}\r\n");
