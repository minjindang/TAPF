...
public final class HAMB0403MScript_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tvar allMoney = srcMoney-founda-foundb-lastFound;\r\n");
      out.write("\tvar nowFound = srcMoney-founda-foundb-lastFound;\r\n");
      ...
      out.write("\t\t\tvar nowFound = srcMoney - lastFound;\r\n");
      out.write("\t\t\tform.elements['bigDecimal(nowFound)'].value = nowFound;//本年度受分配金額\r\n");
      out.write("\t\t\tform.elements['bigDecimal(allMoney)'].value = srcMoney;//本次撥付金額\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\tform.elements['bigDecimal(nowFound)'].value = srcMoney;//本年度受分配金額\r\n");
      out.write("\t\t\tvar allMoney = srcMoney - lastFound;\r\n");
