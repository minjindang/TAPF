...
public final class HAMB0701LForm_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      if (_jspx_eval_display_table_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_display_column_2.setTitle("受分配單位");
          ...
          if (_jspx_eval_display_column_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jspx_th_bean_define_0.setId("qryallYear");
              _jspx_th_bean_define_0.setName("Hamb0701Form");
              _jspx_th_bean_define_0.setProperty("qryallYear");
              ...
              _jspx_th_bean_define_1.setId("qryallMonth");
              _jspx_th_bean_define_1.setName("Hamb0701Form");
              _jspx_th_bean_define_1.setProperty("qryallMonth");
              ...
              _jspx_th_bean_define_2.setId("qryunitName");
              _jspx_th_bean_define_2.setName("Hamb0701Form");
              _jspx_th_bean_define_2.setProperty("qryunitName");
              ...
              _jspx_th_bean_define_3.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_display_column_2);
              _jspx_th_bean_define_3.setId("unitInfo");
              _jspx_th_bean_define_3.setName("row");
              _jspx_th_bean_define_3.setProperty("unitInfo");
              _jspx_th_bean_define_3.setType("tw.gov.nta.sql.UnitInfoMain");
              ...
              _jspx_th_bean_define_4.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_display_column_2);
              _jspx_th_bean_define_4.setId("unitName");
              _jspx_th_bean_define_4.setName("unitInfo");
              _jspx_th_bean_define_4.setProperty("unitName");
              ...
              java.lang.String unitName = null;
              unitName = (java.lang.String) _jspx_page_context.findAttribute("unitName");
              out.write("\r\n");
              out.write("\t\t\t\t\t");
              //  bean:define
              ...
              _jspx_th_bean_define_5.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_display_column_2);
              _jspx_th_bean_define_5.setId("qryunitId");
              _jspx_th_bean_define_5.setName("Hamb0701Form");
              _jspx_th_bean_define_5.setProperty("qryunitId");
              ...
              out.write("  \r\n");
              out.write("\t\t\t\t");
              if (_jspx_meth_html_link_0(_jspx_th_display_column_2, _jspx_page_context))
                return;
              out.write("\t\r\n");
              out.write("\t\t\t\t");
          ...
          _jspx_th_display_column_3.setTitle("寄送日期");
          ...
          if (_jspx_eval_display_column_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jspx_th_logic_notEmpty_0.setProperty("sendDate");
              ...
              if (_jspx_eval_logic_notEmpty_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  _jspx_th_bean_define_7.setId("sendDate");
                  _jspx_th_bean_define_7.setName("row");
                  _jspx_th_bean_define_7.setProperty("sendDate");
                  ...
                  sendDate = (java.util.Date) _jspx_page_context.findAttribute("sendDate");
                  out.write("\r\n");
                  out.write("\t\t\t\t\t\t\t");
                  out.print(DateUtil.toDateTimeRoc(sendDate));
                  out.write("\r\n");
                  out.write("\t\t\t\t\t");
              ...
              _jspx_th_logic_empty_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_display_column_3);
              _jspx_th_logic_empty_0.setName("row");
              _jspx_th_logic_empty_0.setProperty("sendDate");
...
//"0000000 00:00:00"
          ...
          _jspx_th_display_column_4.setTitle("回條接收日期");
          ...
          if (_jspx_eval_display_column_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jspx_th_logic_notEmpty_1.setProperty("recvDate");
              ...
              if (_jspx_eval_logic_notEmpty_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  _jspx_th_bean_define_8.setId("recvDate");
                  _jspx_th_bean_define_8.setName("row");
                  _jspx_th_bean_define_8.setProperty("recvDate");
                  ...
                  recvDate = (java.util.Date) _jspx_page_context.findAttribute("recvDate");
                  out.write("\r\n");
                  out.write("\t\t\t\t\t\t\t");
                  out.print(DateUtil.toDateTimeRoc(recvDate));
                  out.write("\r\n");
                  out.write("\t\t\t\t\t");
              ...
              _jspx_th_logic_empty_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_display_column_4);
              _jspx_th_logic_empty_1.setName("row");
              _jspx_th_logic_empty_1.setProperty("recvDate");
...
//"0000000 00:00:00"
  ...
  private boolean _jspx_meth_display_column_0(javax.servlet.jsp.tagext.JspTag _jspx_th_display_table_0, PageContext _jspx_page_context)
    ...
    _jspx_th_display_column_0.setTitle("記帳年度");
  ...
  private boolean _jspx_meth_display_column_1(javax.servlet.jsp.tagext.JspTag _jspx_th_display_table_0, PageContext _jspx_page_context)
    ...
    _jspx_th_display_column_1.setTitle("撥款月份");
  ...
  private boolean _jspx_meth_html_link_0(javax.servlet.jsp.tagext.JspTag _jspx_th_display_column_2, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  html:link
    ...
    _jspx_th_html_link_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_display_column_2);
    _jspx_th_html_link_0.setAction("/HAMB0703");
    ...
    if (_jspx_eval_html_link_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t");
        if (_jspx_meth_bean_write_2(_jspx_th_html_link_0, _jspx_page_context))
          return true;
        out.write("\r\n");
        out.write("\t\t\t\t");
  ...
  private boolean _jspx_meth_bean_write_2(javax.servlet.jsp.tagext.JspTag _jspx_th_html_link_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  bean:write
    ...
    _jspx_th_bean_write_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_html_link_0);
    _jspx_th_bean_write_2.setName("unitInfo");
    _jspx_th_bean_write_2.setProperty("unitName");
