...
public final class EAMB0101MBar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t");
 tw.gov.nta.account.form.Eamb0101Form queryForm = new  tw.gov.nta.account.form.Eamb0101Form();
				session.setAttribute("Eamb0101Form",queryForm);
  ...
  private boolean _jspx_meth_html_submit_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_0.setValue("回查詢");
  ...
  private boolean _jspx_meth_html_submit_1(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_1.setProperty("goMakeVoucher");
    _jspx_th_html_submit_1.setValue("傳票預覽");
