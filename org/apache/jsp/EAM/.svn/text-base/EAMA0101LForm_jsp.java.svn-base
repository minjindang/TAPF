...
public final class EAMA0101LForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private org.apache.jasper.runtime.TagHandlerPool _jspx_tagPool_display_column_title_property_paramProperty_paramId_href_nobody;
  ...
  public void _jspInit() {
    ...
    _jspx_tagPool_display_column_title_property_paramProperty_paramId_href_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  ...
  public void _jspDestroy() {
    ...
    _jspx_tagPool_display_column_title_property_paramProperty_paramId_href_nobody.release();
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<!--\r\n");
      out.write("程式目的：EAMB01文字\r\n");
      out.write("程式代號：EAMB01\r\n");
  ...
  private boolean _jspx_meth_display_column_0(javax.servlet.jsp.tagext.JspTag _jspx_th_display_table_0, PageContext _jspx_page_context)
    ...
    //  display:column
    org.displaytag.tags.ColumnTag _jspx_th_display_column_0 = (org.displaytag.tags.ColumnTag) _jspx_tagPool_display_column_title_property_paramProperty_paramId_href_nobody.get(org.displaytag.tags.ColumnTag.class);
    ...
    _jspx_th_display_column_0.setTitle("科目代號");
    _jspx_th_display_column_0.setProperty("accountCode");
    _jspx_th_display_column_0.setHref("EAMA0103");
    ...
    if (_jspx_th_display_column_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
      return true;
    _jspx_tagPool_display_column_title_property_paramProperty_paramId_href_nobody.reuse(_jspx_th_display_column_0);
    return false;
  }
  ...
  private boolean _jspx_meth_display_column_1(javax.servlet.jsp.tagext.JspTag _jspx_th_display_table_0, PageContext _jspx_page_context)
    ...
    _jspx_th_display_column_1.setTitle("科目名稱");
    _jspx_th_display_column_1.setProperty("accountName");
  ...
  private boolean _jspx_meth_display_column_2(javax.servlet.jsp.tagext.JspTag _jspx_th_display_table_0, PageContext _jspx_page_context)
    ...
    _jspx_th_display_column_2.setTitle("科目性質");
    ...
    if (_jspx_eval_display_column_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t");
        if (_jspx_meth_logic_equal_0(_jspx_th_display_column_2, _jspx_page_context))
          return true;
        out.write("\r\n");
        out.write("\t\t\t\t\t");
        if (_jspx_meth_logic_equal_1(_jspx_th_display_column_2, _jspx_page_context))
          return true;
        out.write("\r\n");
        out.write("\t\t\t\t");
  ...
  private boolean _jspx_meth_logic_equal_0(javax.servlet.jsp.tagext.JspTag _jspx_th_display_column_2, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  logic:equal
    ...
    _jspx_th_logic_equal_0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_display_column_2);
    _jspx_th_logic_equal_0.setName("row");
    _jspx_th_logic_equal_0.setProperty("accountType");
    _jspx_th_logic_equal_0.setValue("D");
  ...
  private boolean _jspx_meth_logic_equal_1(javax.servlet.jsp.tagext.JspTag _jspx_th_display_column_2, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  logic:equal
    ...
    _jspx_th_logic_equal_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_display_column_2);
    _jspx_th_logic_equal_1.setName("row");
    _jspx_th_logic_equal_1.setProperty("accountType");
    _jspx_th_logic_equal_1.setValue("C");
  ...
  private boolean _jspx_meth_display_column_3(javax.servlet.jsp.tagext.JspTag _jspx_th_display_table_0, PageContext _jspx_page_context)
    ...
    _jspx_th_display_column_3.setTitle("備註");
