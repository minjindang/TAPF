...
public final class BIMA0401MForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>發行年度</td>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>買回期別</td>\r\n");
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>檔案代號</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>國庫券名稱</td>\r\n");
      out.write("\t\t<td class='table_td' colspan=\"3\">\r\n");
      out.write("\t\t\t");
pageContext.setAttribute("collectionIssuecode",tw.gov.nta.debt.common.IssueManager.getDebtNameLabelList("B")); 
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>發行日期</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>到期日期</td>\r\n");
      out.write("\t\t<td class='table_td' colspan=\"3\">\r\n");
      out.write("\t\t\t");
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>發行天數</td>\r\n");
      out.write("\t\t<td class='table_td' id=\"issueDays\" colspan=\"6\">\r\n");
      out.write("\t\t\t");
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>買回日期</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t");
      out.print(gov.dnt.tame.util.CommonFun.addCalendar("date(aheadDate)",new Integer(3)));
      out.write("\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>買回種類</td>\r\n");
      out.write("\t\t<td class='table_td' colspan=\"3\">\r\n");
      out.write("\t\t\t");
      //  logic:empty
      ...
      _jspx_th_logic_empty_0.setName("Bima0401Form");
      ...
      if (_jspx_eval_logic_empty_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("\t\t\t\t");
          out.print(gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(tw.gov.nta.system.common.CodeDetManage.getCodeDet("IK"),"bondType",10,false));
          out.write("\r\n");
          out.write("\t\t\t");
      ...
      _jspx_th_logic_notEmpty_0.setName("Bima0401Form");
      ...
      if (_jspx_eval_logic_notEmpty_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          _jspx_th_bean_define_0.setName("Bima0401Form");
          ...
          java.lang.Integer bondType = null;
          bondType = (java.lang.Integer) _jspx_page_context.findAttribute("bondType");
          out.write("\r\n");
          out.write("\t\t\t\t");
          out.print(gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(tw.gov.nta.system.common.CodeDetManage.getCodeDet("IK"),"bondType",String.valueOf(bondType),false));
          out.write("\r\n");
          out.write("\t\t\t");
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>發行金額</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>報價總面額</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>底價利率</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>買回總面額</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>原始成本</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>利息總額</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("\t</tr>\r\n");
      out.write("\t<tr>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>最高買回利率</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("%\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>最低買回利率</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      ...
      out.write("%\r\n");
      out.write("\t\t</td>\r\n");
      out.write("\t\t<td class='table_item' width='15%'>加權平均利率</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
  ...
  private boolean _jspx_meth_html_hidden_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_0.setName("Bima0401Form");
  ...
  private boolean _jspx_meth_html_text_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_0.setName("Bima0401Form");
  ...
  private boolean _jspx_meth_html_text_1(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_1.setName("Bima0401Form");
  ...
  private boolean _jspx_meth_html_text_2(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_2.setName("Bima0401Form");
    _jspx_th_html_text_2.setProperty("fileNo");
  ...
  private boolean _jspx_meth_html_select_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_select_0.setName("Bima0401Form");
    _jspx_th_html_select_0.setProperty("issueId");
  ...
  private boolean _jspx_meth_html_options_0(javax.servlet.jsp.tagext.JspTag _jspx_th_html_select_0, PageContext _jspx_page_context)
    ...
    _jspx_th_html_options_0.setCollection("collectionIssuecode");
  ...
  private boolean _jspx_meth_bean_write_0(PageContext _jspx_page_context)
    ...
    _jspx_th_bean_write_0.setName("Bima0401Form");
    _jspx_th_bean_write_0.setProperty("issueDays");
  ...
  private boolean _jspx_meth_html_text_5(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_5.setName("Bima0401Form");
    _jspx_th_html_text_5.setProperty("date(aheadDate)");
    _jspx_th_html_text_5.setSize("7");
    _jspx_th_html_text_5.setMaxlength("7");
    _jspx_th_html_text_5.setOnblur("");
  ...
  private boolean _jspx_meth_html_text_6(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_6.setName("Bima0401Form");
    _jspx_th_html_text_6.setProperty("bigDecimal(issueAmount)");
  ...
  private boolean _jspx_meth_html_text_7(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_7.setName("Bima0401Form");
    _jspx_th_html_text_7.setProperty("bigDecimal(bidAmount)");
  ...
  private boolean _jspx_meth_html_text_8(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_8.setName("Bima0401Form");
    _jspx_th_html_text_8.setProperty("bigDecimal(bidRate)");
    _jspx_th_html_text_8.setSize("15");
  ...
  private boolean _jspx_meth_html_text_9(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_9.setName("Bima0401Form");
    _jspx_th_html_text_9.setProperty("bigDecimal(gotbidAmount)");
  ...
  private boolean _jspx_meth_html_text_10(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_10.setName("Bima0401Form");
    _jspx_th_html_text_10.setProperty("bigDecimal(orgissueAmount)");
  ...
  private boolean _jspx_meth_html_text_11(PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  html:text
    org.apache.struts.taglib.html.TextTag _jspx_th_html_text_11 = (org.apache.struts.taglib.html.TextTag) _jspx_tagPool_html_text_size_property_name_nobody.get(org.apache.struts.taglib.html.TextTag.class);
    _jspx_th_html_text_11.setPageContext(_jspx_page_context);
    _jspx_th_html_text_11.setParent(null);
    _jspx_th_html_text_11.setName("Bima0401Form");
    _jspx_th_html_text_11.setProperty("bigDecimal(interestAmount)");
    _jspx_th_html_text_11.setSize("15");
    ...
    if (_jspx_th_html_text_11.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
      return true;
    _jspx_tagPool_html_text_size_property_name_nobody.reuse(_jspx_th_html_text_11);
    return false;
  }
  ...
  private boolean _jspx_meth_html_text_12(PageContext _jspx_page_context)
    ...
    _jspx_th_html_text_12.setName("Bima0401Form");
    _jspx_th_html_text_12.setProperty("bigDecimal(hightRate)");
  ...
  private boolean _jspx_meth_html_text_13(PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  html:text
    org.apache.struts.taglib.html.TextTag _jspx_th_html_text_13 = (org.apache.struts.taglib.html.TextTag) _jspx_tagPool_html_text_size_property_name_nobody.get(org.apache.struts.taglib.html.TextTag.class);
    _jspx_th_html_text_13.setPageContext(_jspx_page_context);
    _jspx_th_html_text_13.setParent(null);
    _jspx_th_html_text_13.setName("Bima0401Form");
    _jspx_th_html_text_13.setProperty("bigDecimal(lowRate)");
    ...
    if (_jspx_th_html_text_13.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
      return true;
    _jspx_tagPool_html_text_size_property_name_nobody.reuse(_jspx_th_html_text_13);
    return false;
  }
  ...
  private boolean _jspx_meth_html_text_14(PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  html:text
    org.apache.struts.taglib.html.TextTag _jspx_th_html_text_14 = (org.apache.struts.taglib.html.TextTag) _jspx_tagPool_html_text_size_property_name_nobody.get(org.apache.struts.taglib.html.TextTag.class);
    _jspx_th_html_text_14.setPageContext(_jspx_page_context);
    _jspx_th_html_text_14.setParent(null);
    _jspx_th_html_text_14.setName("Bima0401Form");
    _jspx_th_html_text_14.setProperty("bigDecimal(averageRate)");
    _jspx_th_html_text_14.setSize("15");
    ...
    if (_jspx_th_html_text_14.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
      return true;
    _jspx_tagPool_html_text_size_property_name_nobody.reuse(_jspx_th_html_text_14);
    return false;
  }
}
