...
public final class BIMA0201MScript_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("}\r\n");
      out.write("function setDueIssueAmount(form){\r\n");
      out.write("\tform.elements['bigDecimal(dueIssueAmount)'].value = addMoneyMask(\r\n");
