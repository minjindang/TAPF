...
public final class BIMA0101LForm_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      if (_jspx_eval_display_table_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_display_column_0.setTitle("發行年度");
          ...
          if (_jspx_eval_display_column_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jspx_th_bean_define_1.setId("qrydebtCode");
              _jspx_th_bean_define_1.setName("Bima0101Form");
              _jspx_th_bean_define_1.setProperty("qrydebtCode");
              ...
              _jspx_th_bean_define_2.setId("qrybudgetCode");
              _jspx_th_bean_define_2.setName("Bima0101Form");
              _jspx_th_bean_define_2.setProperty("qrybudgetCode");
              ...
              _jspx_th_bean_define_3.setId("qryaccountYear");
              _jspx_th_bean_define_3.setName("Bima0101Form");
              _jspx_th_bean_define_3.setProperty("qryaccountYear");
              ...
              java.lang.Integer qrydebtName = null;
              qrydebtName = (java.lang.Integer) _jspx_page_context.findAttribute("qrydebtName");
              out.write("\r\n");
              out.write("\t\t\t\t\t");
          ...
          if (_jspx_eval_display_column_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            ...
            do {
              ...
              _jspx_th_bean_define_6.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_display_column_3);
  ...
  private boolean _jspx_meth_display_column_1(javax.servlet.jsp.tagext.JspTag _jspx_th_display_table_0, PageContext _jspx_page_context)
    ...
    _jspx_th_display_column_1.setTitle("發行期別");
  ...
  private boolean _jspx_meth_display_column_4(javax.servlet.jsp.tagext.JspTag _jspx_th_display_table_0, PageContext _jspx_page_context)
    ...
    _jspx_th_display_column_4.setTitle("國庫券名稱");
    ...
    if (_jspx_eval_display_column_4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t");
        if (_jspx_meth_bean_write_2(_jspx_th_display_column_4, _jspx_page_context))
          return true;
        out.write("\r\n");
        out.write("\t\t\t\t");
  ...
  private boolean _jspx_meth_bean_write_2(javax.servlet.jsp.tagext.JspTag _jspx_th_display_column_4, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  bean:write
    ...
    _jspx_th_bean_write_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_display_column_4);
    _jspx_th_bean_write_2.setName("row");
    _jspx_th_bean_write_2.setProperty("debtName");
