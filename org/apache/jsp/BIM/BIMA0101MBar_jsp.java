...
public final class BIMA0101MBar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_html_submit_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_0.setProperty("goTick");
    _jspx_th_html_submit_0.setValue("債票明細");
  ...
  private boolean _jspx_meth_html_submit_1(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_1.setProperty("doUpd");
    _jspx_th_html_submit_1.setValue("更新");
    _jspx_th_html_submit_1.setOnclick("javascript:return(checkValue(this.form));");
  ...
  private boolean _jspx_meth_html_submit_2(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_2.setProperty("doDel");
    _jspx_th_html_submit_2.setValue("刪除");
    _jspx_th_html_submit_2.setOnclick("javascript:return(checkValue(this.form));");
