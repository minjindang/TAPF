...
<table class='table_1' width='100%'>
	<tr>
		<td class='table_item'><font color='red'>*</font>付息年度:</td>
		<td class='table_td'>
			<html:text name='Airb0401Form' property='repay_SDate' size='3' maxlength='3'/>~
			<html:text name='Airb0401Form' property='repay_EDate' size='3' maxlength='3'/>
		</td>
	</tr>
	<tr>
