...
public final class EAMB0102MBar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_html_submit_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_0.setProperty("doDelVoucher");
    _jspx_th_html_submit_0.setValue("刪除傳票");
  ...
  private boolean _jspx_meth_html_submit_1(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_1.setProperty("doPrintVoucher");
    _jspx_th_html_submit_1.setValue("重新列印傳票");
  ...
  private boolean _jspx_meth_html_submit_2(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_2.setProperty("goVoucherList");
    _jspx_th_html_submit_2.setValue("回傳票列表");
