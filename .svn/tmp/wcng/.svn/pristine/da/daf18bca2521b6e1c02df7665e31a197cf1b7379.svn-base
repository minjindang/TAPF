...
public final class GAMA0502MBar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<!--  html:submit styleClass='formcss_rbutton' property='doUpdDet' value='更新' onclick=\"return(checkForm(form));\"/-->\r\n");
      out.write("\t\t\t");
  ...
  private boolean _jspx_meth_html_submit_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_0.setProperty("doDelDet");
  ...
  private boolean _jspx_meth_html_reset_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_reset_0.setValue("回復");
  ...
  private boolean _jspx_meth_html_submit_2(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_2.setProperty("blackMain");
    _jspx_th_html_submit_2.setValue("中央政府債務歷史資料維護");
