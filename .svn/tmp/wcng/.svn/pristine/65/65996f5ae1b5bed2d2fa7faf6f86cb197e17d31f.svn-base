...
<table class='table_1' width='100%'>
	<tr>
		...
		<td class='table_td'>
			...
			<html:select name='Bira0701Form' property='budgetCode'>
	...
	<tr>
		...
		<td class='table_td'>
			<html:text name='Bira0701Form' property='date(issueSdate)' size='7' maxlength='7' onblur=''/>
			<%=gov.dnt.tame.util.CommonFun.addCalendar("date(issueSdate)", new Integer(0))%>
			 ~ 
			<html:text name='Bira0701Form' property='date(issueEdate)' size='7' maxlength='7' onblur=''/>
