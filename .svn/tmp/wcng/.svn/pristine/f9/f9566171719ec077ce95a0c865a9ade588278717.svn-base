...
<table class='table_1' width='100%'>
	<tr>
		...
		<td class='table_td'>
			<html:text name='Gara1101Form' property='startYear' size='5' maxlength='3'/>	
		</td>
	</tr>
	<tr>
		...
		<td class='table_td'>
			...
			<html:select name='Gara1101Form' property='amountUnit'>
	...
	<tr>
		...
		<td class='table_td'>
			<html:text name='Gara1101Form' property='date(createDate)' size='7' maxlength='7' onblur=''/>
