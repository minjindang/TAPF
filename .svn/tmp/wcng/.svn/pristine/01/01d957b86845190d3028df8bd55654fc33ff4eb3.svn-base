...
public final class AIMA0203MForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspInit() {
    ...
    _jspx_tagPool_html_text_property_onblur_name_nobody = org.apache.jasper.runtime.TagHandlerPool.getTagHandlerPool(getServletConfig());
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    </tr>\r\n");
      out.write("    <tr>\r\n");
      out.write("\t\t<td class='table_item'>發行金額：</td>\r\n");
      out.write("\t\t<td class='table_td'>");
      ...
      out.write("    </tr>\r\n");
      out.write(" \t<tr>\r\n");
      out.write("\t\t<td class='table_item'>公債名稱：</td>\r\n");
      out.write("\t\t<td class='table_td'>");
      ...
      out.write("    </tr>\r\n");
      out.write("    <tr>\r\n");
      out.write("\t\t<td class='table_item'>面額：</td>\r\n");
      out.write("\t\t<td class='table_td'>\r\n");
      out.write("\t\t\t");
      //  logic:empty
      ...
      _jspx_th_logic_empty_0.setName("Aima0203MForm");
      _jspx_th_logic_empty_0.setProperty("ticketAmount");
      int _jspx_eval_logic_empty_0 = _jspx_th_logic_empty_0.doStartTag();
      if (_jspx_eval_logic_empty_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("\t\t\t\t\t");
          out.print(gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(tw.gov.nta.system.common.CodeDetManage.getCodeDet("MY"),"ticketAmount","","","calculateAmount(this.form);total(this.form);",10,false));
          out.write("元\r\n");
          out.write("\t\t\t\t");
      ...
      _jspx_th_logic_notEmpty_0.setName("Aima0203MForm");
      _jspx_th_logic_notEmpty_0.setProperty("ticketAmount");
      ...
      if (_jspx_eval_logic_notEmpty_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          _jspx_th_bean_define_0.setName("Aima0203MForm");
          ...
          java.lang.String ticketAmount = null;
          ticketAmount = (java.lang.String) _jspx_page_context.findAttribute("ticketAmount");
          out.write("\r\n");
          out.write("\t\t\t\t\t");
          out.print(gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(tw.gov.nta.system.common.CodeDetManage.getCodeDet("MY"),"ticketAmount",new java.math.BigDecimal(ticketAmount).setScale(0).toString(),"","calculateAmount(this.form);total(this.form);",10,false));
          out.write("元\r\n");
          out.write("\t\t\t\t");
      ...
      out.write("\t\t<td class='table_td' id=\"totalAmount\">");
  ...
  private boolean _jspx_meth_html_hidden_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_0.setName("Aima0203MForm");
  ...
  private boolean _jspx_meth_html_hidden_1(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_1.setName("Aima0203MForm");
    _jspx_th_html_hidden_1.setProperty("issueTicketDetId");
  ...
  private boolean _jspx_meth_bean_write_0(PageContext _jspx_page_context)
    ...
    _jspx_th_bean_write_0.setName("Aima0203MForm");
  ...
  private boolean _jspx_meth_bean_write_1(PageContext _jspx_page_context)
    ...
    _jspx_th_bean_write_1.setName("Aima0203MForm");
  ...
  private boolean _jspx_meth_bean_write_2(PageContext _jspx_page_context)
    ...
    _jspx_th_bean_write_2.setName("Aima0203MForm");
  ...
  private boolean _jspx_meth_bean_write_3(PageContext _jspx_page_context)
    ...
    _jspx_th_bean_write_3.setName("Aima0203MForm");
  ...
  private boolean _jspx_meth_html_text_0(PageContext _jspx_page_context)
    ...
    JspWriter out = _jspx_page_context.getOut();
    //  html:text
    org.apache.struts.taglib.html.TextTag _jspx_th_html_text_0 = (org.apache.struts.taglib.html.TextTag) _jspx_tagPool_html_text_property_onblur_name_nobody.get(org.apache.struts.taglib.html.TextTag.class);
    _jspx_th_html_text_0.setPageContext(_jspx_page_context);
    _jspx_th_html_text_0.setParent(null);
    _jspx_th_html_text_0.setName("Aima0203MForm");
    _jspx_th_html_text_0.setProperty("ticketCount");
    _jspx_th_html_text_0.setOnblur("total(this.form);calculateAmount(this.form);");
    int _jspx_eval_html_text_0 = _jspx_th_html_text_0.doStartTag();
    if (_jspx_th_html_text_0.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE)
      return true;
    _jspx_tagPool_html_text_property_onblur_name_nobody.reuse(_jspx_th_html_text_0);
    return false;
  }
  ...
  private boolean _jspx_meth_bean_write_4(PageContext _jspx_page_context)
    ...
    _jspx_th_bean_write_4.setName("Aima0203MForm");
    _jspx_th_bean_write_4.setProperty("BigDecimal(totalAmount)");
