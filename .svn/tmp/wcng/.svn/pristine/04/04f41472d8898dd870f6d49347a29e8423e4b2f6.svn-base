...
public final class GAMA0101MScript_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("{\r\n");
      out.write("\tform.action = \"GAMA0101MLIST\" ;\r\n");
      ...
      out.write("\t\t{\r\n");
      out.write("\t\t\tform.textCount.value = daycount(bigDate,endDate,type) ;\r\n");
      out.write("\t\t\tdocument.getElementById(\"dayid\").innerHTML = daycount(bigDate,endDate,type) ;\r\n");
      out.write("\t\t}\r\n");
      out.write("}\r\n");
      ...
      out.write("{\r\n");
      out.write("\tvar cols = new Array( \"date(issueDate)\" , \"date(dueDate)\" , \"bigDecimal(expectAmount)\",\"date(continueDate)\");\r\n");
      out.write("\tvar colNames = new Array( \"【借款起日】\" ,  \"【借款迄日】\" , \"【預計借款金額】\",\"【承接日期】\");\r\n");
