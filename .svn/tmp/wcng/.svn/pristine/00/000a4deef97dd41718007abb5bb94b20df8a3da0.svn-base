...
public final class AIMA0101MScript_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("{\r\n");
      out.write("\toNumberMask = new Mask(\"###.000\", \"number\");\r\n");
      out.write("\tmoneyCols = new Array(\"BigDecimal(averageRate)\");\r\n");
      ...
      out.write("{\r\n");
      out.write("\tvar cols = new Array(\"issueSerial\" , \"bondKind\", \"bondType\", \"issueKind\", \"budgetCode\", \"debtCode\", \"accountYear\", \"debtName\", \"Date(issueDate)\", \"BigDecimal(issueAmount)\", \"issueInterval\", \"rateKind\", \"BigDecimal(averageRate)\", \"Date(firstInterestDate)\", \"interestAlternate\", \"Date(firstRepayDate)\", \"repayAlternate\", \"payLimit\");\r\n");
      out.write("\tvar colNames = new Array(\"公債代號\", \"公債發行種類\", \"公債識別碼\", \"公債型式\", \"預算別\", \"債務別\", \"會計年度\", \"公債名稱\", \"發行日期\", \"發行額\", \"期限\", \"利率變動別\", \"利率年息\", \"首次付息日期\", \"付息次數\", \"首次還本日期\", \"還本次數\", \"有效兌付期限\");\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function doBlur(form){\r\n");
      out.write("\tform.action=\"AIMA0100M\";\r\n");
      out.write("\tform.submit();\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function changeList(form)\r\n");
      out.write("{\r\n");
      out.write("\tdoAction(\"AIMA0101MList\");\r\n");
      out.write("}\r\n");
      out.write("</script>");
    } catch (Throwable t) {
