...
public final class GAMA0102MLLBar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_html_submit_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_0.setProperty("goAddCap");
    _jspx_th_html_submit_0.setValue("新增還本付息期別");
  ...
  private boolean _jspx_meth_html_submit_1(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_1.setProperty("doComitCap");
    _jspx_th_html_submit_1.setValue("確認還本付息期別");
