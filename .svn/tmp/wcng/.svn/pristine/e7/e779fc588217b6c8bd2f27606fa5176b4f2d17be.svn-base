...
function total(form)
{
	...
	totalIssueAmount = <%= request.getAttribute("totalIssueAmount") %> - <bean:write name='Aima0203MForm' property='ticketAmount'/>*<bean:write name='Aima0203MForm' property='ticketCount'/>;
