...
public final class EAMB0101QBar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      _jspx_th_logic_notEmpty_0.setName("collection");
	...
	//特殊傳票不進行批次產生傳票
          ...
          out.write("\r\n");
          out.write("\t\t\t\t\t");
          if (_jspx_meth_html_submit_1(_jspx_th_logic_notEmpty_0, _jspx_page_context))
            return;
          out.write("\r\n");
          out.write("\t\t\t\t");
}
  ...
  private boolean _jspx_meth_html_submit_1(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_notEmpty_0, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  html:submit
    ...
    _jspx_th_html_submit_1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_logic_notEmpty_0);
    _jspx_th_html_submit_1.setStyleClass("formcss_rbutton");
    _jspx_th_html_submit_1.setProperty("batchMakeVoucher");
    _jspx_th_html_submit_1.setValue("批次產生傳票");
