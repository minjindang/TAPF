...
public final class HAMA0301MBar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_html_submit_1(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_1.setProperty("export");
    _jspx_th_html_submit_1.setValue("匯出");
  ...
  private boolean _jspx_meth_html_submit_2(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_2.setProperty("import");
    _jspx_th_html_submit_2.setValue("匯入");
    _jspx_th_html_submit_2.setOnclick("return checkForm2(this.form);");
