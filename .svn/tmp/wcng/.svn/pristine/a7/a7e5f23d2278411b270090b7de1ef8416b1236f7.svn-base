...
<table class='table_1' width='100%'>
	<tr>
		...
		<td class='table_td'>
			<html:text name="Gara3101Form" property="issueSDate" maxlength="3" size="5" />~
			<html:text name="Gara3101Form" property="issueEDate" maxlength="3" size="5" />
		</td>
	</tr>
	<tr>
		...
		<td class='table_td'>
			...
			<html:select name='Gara3101Form' property='amountUnit'>
