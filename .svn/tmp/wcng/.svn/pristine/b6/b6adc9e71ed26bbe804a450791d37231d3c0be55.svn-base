...
public final class HAMB0601MForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_html_hidden_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_hidden_0.setName("Hamb0601Form");
  ...
  private boolean _jspx_meth_html_select_0(PageContext _jspx_page_context)
    ...
    _jspx_th_html_select_0.setOnchange("form.action='HAMB06'; form.submit();");
