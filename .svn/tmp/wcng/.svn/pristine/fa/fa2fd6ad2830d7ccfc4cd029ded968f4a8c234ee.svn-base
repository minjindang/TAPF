...
public final class FAMA0301MBar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_logic_equal_0(PageContext _jspx_page_context)
    ...
    _jspx_th_logic_equal_0.setName("Fama0301Form");
    _jspx_th_logic_equal_0.setProperty("qry");
  ...
  private boolean _jspx_meth_logic_equal_1(PageContext _jspx_page_context)
    ...
    _jspx_th_logic_equal_1.setName("Fama0301Form");
    _jspx_th_logic_equal_1.setProperty("qry");
    _jspx_th_logic_equal_1.setValue("N");
    int _jspx_eval_logic_equal_1 = _jspx_th_logic_equal_1.doStartTag();
    if (_jspx_eval_logic_equal_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t\t");
        if (_jspx_meth_html_submit_2(_jspx_th_logic_equal_1, _jspx_page_context))
          return true;
        out.write("\r\n");
        out.write("\t\t\t");
  ...
  private boolean _jspx_meth_html_submit_2(javax.servlet.jsp.tagext.JspTag _jspx_th_logic_equal_1, PageContext _jspx_page_context)
          throws Throwable {
    PageContext pageContext = _jspx_page_context;
    JspWriter out = _jspx_page_context.getOut();
    //  html:submit
    ...
    _jspx_th_html_submit_2.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_logic_equal_1);
    _jspx_th_html_submit_2.setStyleClass("formcss_rbutton");
    _jspx_th_html_submit_2.setProperty("goAdd");
    _jspx_th_html_submit_2.setValue("回新增");
  ...
  private boolean _jspx_meth_html_submit_3(PageContext _jspx_page_context)
    ...
    _jspx_th_html_submit_3.setProperty("doDel");
    _jspx_th_html_submit_3.setValue("刪除");
