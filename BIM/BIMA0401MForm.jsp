...
<html:hidden name='Bima0401Form' property='id' />
<table class='table_1' width='100%'>
	...
	<tr>
		...
		<td class='table_td' id="issueDays" colspan="6">
			<bean:write name='Bima0401Form' property='issueDays'/>
		</td>
	</tr>
	<tr>
		...
		<td class='table_td' colspan="3">
			<logic:empty name='Bima0401Form' property='bondType'>
			...
			<logic:notEmpty name='Bima0401Form' property='bondType'>
				<bean:define id="bondType" name='Bima0401Form' property="bondType" type="java.lang.Integer"/>
				<%=gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(tw.gov.nta.system.common.CodeDetManage.getCodeDet("IK"),"bondType",String.valueOf(bondType),false)%>
			</logic:notEmpty>
		</td>
	</tr>
	<tr>
