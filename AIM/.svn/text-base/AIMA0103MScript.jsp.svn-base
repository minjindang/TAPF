...
function total(form)
{
	...
	totalIssueAmount = <%= request.getAttribute("totalIssueAmount") %> - <bean:write name='Aima0103MForm' property='ticketAmount'/>*<bean:write name='Aima0103MForm' property='ticketCount'/>;
