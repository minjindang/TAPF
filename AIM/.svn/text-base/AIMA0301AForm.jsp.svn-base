...
<table class='table_1' width='100%'>
	...
	<bean:define id="issueMain" name="Aima0301AForm" property='issueMain' type="tw.gov.nta.sql.debt.IssueMain"/>
		<tr>
			...
			<td class='table_td'><html:text name='Aima0301AForm' property='accountYear' size='17' maxlength='17' onblur="changeList(this.form)"/></td>
		</tr>
		<tr>
			...
			<td class='table_td'><html:text name='Aima0301AForm' property='issueSerial' size='10' /></td>
        </tr>
		<tr>			
