...
<table class='table_1' width='100%'>
        ...
        <tr>
			...
			<td class='table_td'><bean:write name='Aima0103MForm' property='BigDecimal(issueAmount)' format='#,###'/>元</td>
        ...
        <tr>
			...
			<td class='table_td'>
				<logic:empty name='Aima0103MForm' property='ticketAmount'>
					<%=gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(tw.gov.nta.system.common.CodeDetManage.getCodeDet("MY"),"ticketAmount","","","countTotalAmount(this.form);",10,false)%>元
				</logic:empty>
				<logic:notEmpty name='Aima0103MForm' property='ticketAmount'>
					...
					<%=gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(tw.gov.nta.system.common.CodeDetManage.getCodeDet("MY"),"ticketAmount",new java.math.BigDecimal(ticketAmount).setScale(0).toString(),"","countTotalAmount(this.form);",10,false)%>元
				</logic:notEmpty>
			</td>
