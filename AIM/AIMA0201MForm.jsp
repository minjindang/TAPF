...
<input type='hidden' name='soruceIssueDate' value='<%= gov.dnt.tame.util.DateUtil.date2ROCStr(sourceIssueMain.getIssueDate())%>'>
...
<table class='table_1' width='100%'>
	<tr>
		...
		<td class='table_td'  colspan="3">
			<html:text name='Aima0201MForm' property='Date(issueDate)' size='7' maxlength='7' onblur="countDay(this.form);doAction('AIMA0200M');"/>
	...
	<tr>
		...
		<td class='table_td'>
			<%=gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(tw.gov.nta.system.common.CodeDetManage.getCodeDet("BT"),"bondType",issueMain.getBondType(),"","doAction('AIMA0200M');",10, false)%>&nbsp;
		</td>
