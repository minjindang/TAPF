...
<table class='table_1' width='100%'>
	<tr>
		...
		<td class='table_td'>
			<html:select name='Airc0901Form' property="issueSerial" value="issueSerial" >
				<html:option value="">請選擇</html:option>
				<html:optionsCollection name='Airc0901Form' property="issueSerialList" label="label" value="valuess" />
			</html:select>
		</td>
	</tr>
	<tr>
		...
		<td class='table_td'>
			<html:text name='Airc0901Form' property='date(limitDate)' size='7' maxlength='7'/>
