...
<table class='table_1' width='100%'>
	...
	<tr>
		...
		<td class='table_td'>
			<logic:empty name='Fama0501Form' property='belongToBankId'>
				<%=gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(gov.dnt.tame.util.ListToolManager.getList("select id, bankCode+bankName from BankRef where 1=1 and combinationBankId='' order by bankCode"),"belongToBankId","",10, false)%>
			</logic:empty>
			<logic:notEmpty name='Fama0501Form' property='belongToBankId'>
				<bean:define id='belongToBankId' name='Fama0501Form' property='belongToBankId' type='java.lang.Integer'/>
				<%=gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(gov.dnt.tame.util.ListToolManager.getList("select id, bankCode+bankName from BankRef where 1=1 and combinationBankId='' order by bankCode"),"belongToBankId",belongToBankId.toString(),10, false)%>
			</logic:notEmpty>
		</td>
	</tr>
	<tr>
		...
		<td class='table_td'>
			<logic:empty name='Fama0501Form' property='combinationBankId'>
			...
			<logic:notEmpty name='Fama0501Form' property='combinationBankId'>
				<bean:define id='id' name='Fama0501Form' property='id' type='java.lang.Integer'/>
				<bean:define id='combinationBankId' name='Fama0501Form' property='combinationBankId' type='java.lang.Integer'/>
				<%=gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(gov.dnt.tame.util.ListToolManager.getList("select id, bankCode+bankName from BankRef where 1=1  and id <> "+id+"order by bankCode"),"combinationBankId",combinationBankId.toString(),10, false)%>
			</logic:notEmpty>
		</td>
	</tr>
	<tr>
...
<html:hidden name='Fama0501Form' property="date(beginDate)"/>
<html:hidden name='Fama0501Form' property="date(endDate)"/>
<html:hidden name='Fama0501Form' property="date(createDate)"/>