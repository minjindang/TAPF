...
<table class='table_1' width='100%'>
	<tr>
		...
		<td class='table_td'>
			<html:text name="Gara2401Form" property="accountSyear" maxlength="3" size="5" />~
			<html:text name="Gara2401Form" property="accountEyear" maxlength="3" size="5" />
		</td>
	</tr>
	<tr>
		...
		<td class='table_td'>
			...
			<html:select name='Gara2401Form' property='amountUnit'>
