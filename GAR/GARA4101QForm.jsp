...
<table class='table_1' width='100%'>
	<tr>
		...
		<td class='table_td'>
			<html:text name='Gara4101Form' property='accountSYear' size='4' maxlength='3'/>
			 ~ 
			<html:text name='Gara4101Form' property='accountEYear' size='4' maxlength='3'/>
		</td>
	</tr>
	<tr>
		...
		<td class='table_td'>
			...
			<html:select name='Gara4101Form' property='amountUnit'>
