...
<table class='table_1' width='100%'>
	<tr>
		...
		<td class='table_td'>
			<html:text name="Gara1601Form" property="issueSyear" maxlength="3" size="5" />~
			<html:text name="Gara1601Form" property="issueEyear" maxlength="3" size="5" />
		</td>
	</tr>
	<tr>
		...
		<td class='table_td'>
			...
			<html:select name='Gara1601Form' property='amountUnit'>
