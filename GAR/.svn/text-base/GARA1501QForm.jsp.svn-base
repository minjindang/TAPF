...
<table class='table_1' width='100%'>
	<tr>
		...
		<td class='table_td'>
			<html:text name="Gara1501Form" property="issueSdate" maxlength="3" size="5" />
		</td>
	</tr>
	<tr>
		...
		<td class='table_td'>
			...
			<html:select name='Gara1501Form' property='amountUnit'>
	...
	<tr>
		...
		<td class='table_td'>
			<html:text name='Gara1501Form' property='date(createDate)' size='7' maxlength='7' onblur=''/>
