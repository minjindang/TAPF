...
<table class='table_1' width='100%'>
	<tr>
		<td class='table_item' width='30%'><font color="red">*</font>發行年度</td>
		<td class='table_td'>
			<html:text name='Gara1201Form' property='issueYear' size='5' maxlength='3'/>	
		</td>
	</tr>
	<tr>
		...
		<td class='table_td'>
			...
			<html:select name='Gara1201Form' property='amountUnit'>
	...
	<tr>
		...
		<td class='table_td'>
			<html:text name='Gara1201Form' property='date(createDate)' size='7' maxlength='7' onblur=''/>
