	...
	<td>
		<display:table class="table_list" name="collection" id="row">	
			<display:column title="受分配單位代號">
				...
				<bean:define id="qryUnitId" name="Hama0401Form" property="qryUnitId" type="java.lang.String"/>
				<bean:define id="qryUnit" name="Hama0401Form" property="qryUnit" type="java.lang.String"/>
				<bean:define id="qryTyear" name="Hama0401Form" property="qryTyear" type="java.lang.String"/>
				<bean:define id="pageL" name="Hama0401Form" property="page" type="java.lang.Integer"/>
				...
				<%
						java.util.Map paramMap = new java.util.HashMap();
							...
							paramMap.put("tpercent",tw.gov.nta.central.common.UnitPercent101.getByYear(unitInfo,qryTyear).getTpercent());
						pageContext.setAttribute("paramMap", paramMap);
				%>  
				<html:link action='/HAMA0401' name='paramMap'>
			...
			<display:column title="受分配比例">
				<bean:define id="unitInfo" name="row" type="tw.gov.nta.sql.UnitInfoMain"/>
				<bean:define id="qryYear" name="Hama0401Form" property="qryTyear" type="java.lang.String"/>
				<%
