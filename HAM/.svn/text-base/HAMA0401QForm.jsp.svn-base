...
<table class='table_1' width='100%'>
	<tr>
		...
		<td class='table_td' colspan="80%">
			<html:text name='Hama0401Form' property='qryUnit' size='20' maxlength='10'/>
		</td>
	</tr>
	<tr>
		<td class='table_item' colspan="20%">受分配單位名稱</td>
		<td class='table_td' colspan="80%">
			<logic:notEmpty name="Hama0401Form" property='qryUnitId'>
			...
			<logic:empty name="Hama0401Form" property='qryUnitId'>
