...
<table class='table_1' width='100%'>
	...
	<tr>
		...
		<td class='table_td'>
			<bean:write name='Hamb0401Form' property='bigDecimal(lastFound)' format="#,##0"/>
			<html:hidden name='Hamb0401Form' property='bigDecimal(lastFound)'/>
		</td>
	</tr>
	<tr>
		<td class='table_item' width="20%"><font color='red'>*</font>歸扣墊借款</td>
		<td class='table_td'>
			<html:text name='Hamb0401Form' property='bigDecimal(founda)' size='15' maxlength='15' onblur="countTotal(this.form);"/>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class='table_td'>
			...
			<html:hidden name='Hamb0401Form' property='bigDecimal(allMoney)'/>
		</td>
	</tr>
	<tr>
