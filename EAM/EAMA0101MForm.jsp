...
<html:hidden property="id" name="Eama0101Form"/>
<html:hidden property="debtType.id" name="Eama0101Form"/>
	...
	<tbody>
		<tr>
			...
			<td class="table_td"><html:text name="Eama0101Form"
				property="accountCode" size="50" maxlength="50">
			</html:text></td>
		...
		<tr>
			...
			<td class="table_td">
			   <html:textarea name="Eama0101Form" property="remark" rows="3" />
			</td>
		</tr>
	</tbody>
</table>
