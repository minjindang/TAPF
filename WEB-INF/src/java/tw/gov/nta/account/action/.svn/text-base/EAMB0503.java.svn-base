...
public class EAMB0503 extends DefaultAction {
	...
	// TODO Auto-generated method stub
		...
		try {		
			manager.cancelPost(myform.getAccountYear(),myform.getAccountMonth(),debtType,this.getUserId(request),
					issueYear,issueId);	
			setAlertMessage(request,"已取消過帳");
