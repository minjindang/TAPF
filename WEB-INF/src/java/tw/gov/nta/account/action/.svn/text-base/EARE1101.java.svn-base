...
public class EARE1101 extends DefaultAction{
	
	protected SQLJob delTemp(ActionForm form,String usrId){
		SQLJob sqljob = new SQLJob();
		sqljob.appendSQL("DELETE FROM EARE11_RPT ");
...
order by a.account_year,substring(b.debt_serial,1,5)+SUBSTRING(b.debt_serial,7,1),b.debt_code
	...
	protected SQLJob insTemp(ActionForm form,String usrId){
		...
		SQLJob sqljob = new SQLJob();
		sqljob.appendSQL(" INSERT INTO EARE11_RPT (USRID,MOD_DATE,remark,debt_name,issue_date,due_date,average_rate,issue_amount,capital_amount,pay_amount,remain_capital,interest_amount, origin_interest_amount,total_amount,divided ) ");
...
//						 " ((b.o_divided - b.d_divided) - ((b.o_divided - b.d_divided)/a.interest_alternate) * (select isnull(Max(d.interest_serial),0) from debt_plan_det d where b.id = d.debt_id and right('0000000'+convert(varchar,(convert(varchar,d.repay_date, 112)-19110000)),7) < '"+myForm.getLastDate()+"' )) as divided");
		                 " ((b.diversity_amount) - ((b.diversity_amount)/a.interest_alternate) * (select isnull(Max(d.interest_serial),0) from debt_plan_det d where b.id = d.debt_id and right('0000000'+convert(varchar,(convert(varchar,d.repay_date, 112)-19110000)),7) < '"+myForm.getLastDate()+"' )) as divided");
		...
		sqljob.appendSQL(" group by a.account_year,a.source_issue_id,b.debt_code, e.DEBIT_NAME,b.o_divided,b.d_divided,a.ISSUE_INTERVAL,a.due_date,a.interest_alternate,b.id,b.diversity_amount ");
