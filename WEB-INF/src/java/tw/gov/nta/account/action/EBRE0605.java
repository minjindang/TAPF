...
public class EBRE0605 extends JacobReportAction
{
	...
	protected Map getReportParameter(ActionForm form, HttpServletRequest request) {
		...
		if ( issueDate == null || issueDate.equals("") || issueDate.substring(0,3).equals("")){
			...
			map.put("A4","中華民國"+issueDate.substring(0,3)+"年"+issueDate.substring(4,6)+"月"+issueDate.substring(7,9)+"日");				
		}else{
			map.put("A4","中華民國"+issueDate.substring(1,3)+"年"+issueDate.substring(4,6)+"月"+issueDate.substring(7,9)+"日");							
		} 
	...
	protected String getProgramName(Connection connection, String programId) throws SQLException {
		...
		return super.getProgramName(connection,"EBRE06");
	}
