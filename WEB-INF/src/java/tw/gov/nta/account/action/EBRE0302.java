...
public class EBRE0302 extends DefaultAction {
...
GROUP BY  d.debt_name,a.account_name,e.budget_name,f.debit_name
	...
	*/
	protected SQLJob delTemp(ActionForm form,String usrId){
		...
		sqljob.appendSQL("DELETE FROM EBRE03_RPT ");
	...
	protected SQLJob mainsql(AccountQueryForm myform,String usrId){
		SQLJob sqljob = new SQLJob();
		sqljob.appendSQL("");
		sqljob.appendSQL("INSERT INTO EBRE03_RPT ");
	...
	public void executeQuery(ActionForm form, HttpServletRequest request, Connection connection) throws Exception {
		...
		// 查詢條件
//		Date queryDate  = DateUtil.str2Date(DateUtil.getLastDateOfMonth(myForm.getAccountYear(),myForm.getMonth()));
