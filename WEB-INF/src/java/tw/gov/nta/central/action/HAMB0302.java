...
public class HAMB0302 extends DefaultAction {
	...
	public void executeQuery(ActionForm form, HttpServletRequest request,
		...
		{	
			try{
				myform.setTotMon(
						...
						,myform.getLocalTax(),myform.getIntTax(),myform.getUsrid(), new BigDecimal(0),
				...
				myform.setFillAmount(
						...
						myform.getTaxMonth(),myform.getTaxKind(),myform.getNationTax(),
						myform.getLocalTax(),myform.getIntTax(),myform.getUsrid(),
						myform.getNationRate(),myform.getLocalRate(),myform.getIntRate())
						);
				myform.setFillAmount(myform.getTotMon().subtract(myform.getFillAmount()));
				Taxaction.updateformoney(myform.getId(),myform.getNationTax(),myform.getLocalTax(),myform.getIntTax(),myform.getFillAmount(),
						myform.getNationRate(),myform.getLocalRate(),myform.getIntRate());
		...
		{	
			...
			Taxaction.updateformoney(myDet.getId(),myform.getNationTax(),myform.getLocalTax(),myform.getIntTax(),new BigDecimal(0),
					myform.getNationRate(),myform.getLocalRate(),myform.getIntRate());
