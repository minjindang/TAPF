 ...
 * 視窗 - 喜好設定 - Java - 程式碼樣式 - 程式碼範本
 */
public class HAMC0401 extends DefaultAction {
	...
	public void executeQuery(ActionForm form, HttpServletRequest request, Connection connection) throws Exception {
		...
		unitAllocateMain.setMonKind("2");
		hamb0401form.setQryTotal( UnitAllocate.Account(hamb0401form.getQryAllYear(),hamb0401form.getQryAllMonth(),"2") );

		List collection = UnitAllocate.get(unitAllocateMain);
