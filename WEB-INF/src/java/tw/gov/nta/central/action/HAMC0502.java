 ...
 * 提供使用者設定電子郵件內容資料
 */
public class HAMC0502 extends DefaultAction
{ 
			...
			Connection connection) throws Exception 
	{
        ...
        if(hamb0501Form.getCreateDate()==null)
        	hamb0501Form.setCreateDate(new Date());
        hamb0501Form.setUsrid((request.getSession().getAttribute("ID")).toString());
        //呼叫MailContent物件之update(id,畫面,欄位)Method,
        //將畫面的郵件內容資料儲存至資料庫檔案
        if(hamb0501Form.getId() == 0)
        	hamb0501Form.setId(null);
