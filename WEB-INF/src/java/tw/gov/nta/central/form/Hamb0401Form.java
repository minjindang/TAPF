...
public class Hamb0401Form extends SupportForm{
	...
	private String impYear ;//匯入年度
	private String impMonKind;//匯入類別
	...
	public String getImpMonKind() {
		return impMonKind;
	}
	public void setImpMonKind(String impMonKind) {
		this.impMonKind = impMonKind;
	}
	public String getImpYear() {
		return impYear;
	}
	public void setImpYear(String impYear) {
		this.impYear = impYear;
	}
