...
public class Gara3301Form extends GaraBaseForm {
	...
	public void setIssueEDate(String accountEyear) {
		this.issueEDate = accountEyear;
	}
	public String getIssueSDate() {
		return issueSDate;
	}
	public void setIssueSDate(String accountSyear) {
		this.issueSDate = accountSyear;
	}
