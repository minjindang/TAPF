...
public class AIMA0103M extends DefaultAction {
	public void executeQuery(ActionForm form, HttpServletRequest request, Connection connection) throws Exception {
		Aima0103MForm aima0103MForm = (Aima0103MForm) form;
		if(request.getAttribute("ticketDetId")!=null)
			aima0103MForm.setIssueTicketDet(new TicketManager().getBean(Integer.parseInt(request.getAttribute("ticketDetId").toString())));
		else
