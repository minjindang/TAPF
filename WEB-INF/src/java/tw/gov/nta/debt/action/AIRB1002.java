...
public class AIRB1002 extends ExcelReportAction {
	...
	public Map getReportParameter(ActionMapping mapping, ActionForm form,
		...
		Airb1001Form myform = (Airb1001Form) form;
		...
		parameters.put("P1","截止中華民國"+DateUtil.date2ChineseROC2(myform.getLimitDate())+"止");
		parameters.put("P3",AIRB0302.budgetDebitName(myform.getBudgetCode().toString()  ,"",null,null  ));
