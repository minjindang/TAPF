...
public class AIMA0104CMAction extends DefaultAction {
	...
	public void executeQuery(ActionForm form, HttpServletRequest request, Connection connection) throws Exception {
		...
		List tDebtList = new DebtManager().getBeanByIssue(aima0104MForm.getIssueMainId());
		...
		tRateManager.upDateIssueRate(aima0104MForm.getIssueMainId(),tDebtRateList);
