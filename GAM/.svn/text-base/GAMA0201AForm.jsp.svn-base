...
<table class='table_1' width='100%'>
	<tr>
		...
		<td class='table_td'>
			<logic:notEmpty name="Gama0201Form" property="nationRefId">
			...
			<logic:empty name="Gama0201Form" property="nationRefId">
				<%=gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(tw.gov.nta.system.common.NationCodeManager.getNationInfo(),"nationRefId","","","checkDate(this.form)",10,false)%>
			</logic:empty>
		</td>
	</tr>
	<tr>
