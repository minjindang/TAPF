...
<html:hidden name='Cima0101Form' property='nowindex' />
	...
	<tr>
		...
		<td class='table_td'>
			<html:text name='Cima0101Form' style="text-align: right" property='bigDecimal(capitalAmountDPT)' size='50' maxlength='20'/>	
	...
	<tr>
		...
		<td class='table_td' >
			<html:text name='Cima0101Form' style="text-align: right" property='bigDecimal(interestAmountDPT)' size='50' maxlength='20'/>	
	...
	<tr>
		...
		<td class='table_td' >
			<html:text name='Cima0101Form' style="text-align: right" property='bigDecimal(totalAmount)' size='50' maxlength='20'/>	
