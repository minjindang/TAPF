...
{		
		...
		{
			form.textCount.value = daycount(bigDate,endDate,type) ;
			document.getElementById("dayid").innerHTML = daycount(bigDate,endDate,type) ;
		}
}
...
{
	var cols = new Array( "date(issueDate)" , "date(dueDate)" , "bigDecimal(expectAmount)","date(continueDate)");
	var colNames = new Array( "【借款起日】" ,  "【借款迄日】" , "【預計借款金額】","【承接日期】");
