...
<table class='table_1' width='100%'>
	...
	<tr>
		...
		<td class='table_td'>
			<html:text name='Cima0101Form' style="text-align: right" property='bigDecimal(compareAmount)' size='45' maxlength='20'/>
		</td>
	</tr>
	<tr>
		<td class='table_item'><font color="red">*</font>利率</td>
		<td class='table_td'>
			<html:text name='Cima0101Form' style="text-align: right" property='bigDecimal(compareRate)' size='45' maxlength='20' onmousemove="rateLimit(this.form)"/>
		</td>
	</tr>
	<tr>
		<td class='table_item'><font color="red">*</font>得標金額</td>
		<td class='table_td'>
			<html:text name='Cima0101Form' style="text-align: right" property='bigDecimal(issueAmountDet)' size='45' maxlength='50' onblur="changeAmount(this.form)"/>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td class='table_item' width="25%"><font color="red">*</font>本息合計</td>
		<td class='table_td' width="30%" id="totalAmountid" align="right">
