...
<table class='table_1' width='100%'>
	<html:hidden name='Gama0801Form' property='id'/>
	<html:hidden name='Gama0801Form' property='id1'/>
	<tr>
	...
	<tr>
		...
		<td class='table_td' colspan="3"> 
			<logic:empty name='Gama0801Form' property='debtCode'>
			...
			<logic:notEmpty name='Gama0801Form' property='debtCode'>
				<bean:define id="debtCode" name='Gama0801Form' property='debtCode' type="java.lang.Integer"/>
				<%=gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(tw.gov.nta.system.common.DebitCodeManage.getDebitInfo(),"debtCode",String.valueOf(debtCode),false)%>
			</logic:notEmpty>
		</td>
	</tr>
	<tr>
