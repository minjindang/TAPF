...
<html:hidden name='Gama0601Form' property='id' />
<table class='table_1' width='100%'>
	<tr>
		<td class='table_item'><font color='red'>*</font>期別</td>
		<td class='table_td'>
			<bean:define id='issueId' name='Gama0601Form' property='issueId' type='java.lang.Integer' />
			<%=gov.dnt.tame.util.CombinText.getAutoComCodeListWithSpaceBySql(gov.dnt.tame.util.ListToolManager.getList("select id, debtName from IssueMain where debtType='E' "),"issueId",issueId.toString(),10, false)%>
		</td>
	</tr>
	<tr>
