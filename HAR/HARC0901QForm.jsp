...
<html:hidden name='Harb0901Form' property='monKind' value="2"/>
<table class='table_1' width='100%'>
	<tr>
		...
		<td class='table_td'>
			<html:select name="Harb0901Form" property="prtKind">
				...
				<html:optionsCollection name="Harb0901Form" property="prtKindList" label="label" value="valuess" />
			</html:select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class='table_td'>
			<html:select name="Harb0901Form" property="supYear" onchange="form.action='HARC09'; form.submit();">
				<html:option value = "">請選擇</html:option>
